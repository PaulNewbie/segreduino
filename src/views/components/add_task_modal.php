<div id="taskModal" class="custom-modal">
  <form id="addTasksForm" method="post" action="/controllers/Actions/add_tasks.php" class="modal-form" style="padding: 24px; border-radius: 12px; width: 100%; max-width: 420px; gap: 16px; display: flex; flex-direction: column;">
    <h2 style="margin: 0 0 10px 0; font-size: 22px; color: #333;">Add Task</h2>
    ...
    <div style="display:flex; gap:12px;">
      <div style="flex:1;">
        ...
        <select id="task_machine_id" name="machine_id" required style="width: 100%; padding: 12px 14px; border-radius: 8px; border: 1px solid #ddd; outline: none; font-size: 14px; background: #fafafa; cursor: pointer;">
      ...
      <div style="flex:1;">
        ...
        <select id="task_bin_id" name="bin_id" required style="width: 100%; padding: 12px 14px; border-radius: 8px; border: 1px solid #ddd; outline: none; font-size: 14px; background: #fafafa; cursor: pointer;">
    ...
    <div>
        ...
        <input type="text" list="commonTasksList" name="task_description" placeholder="Select from list or type a custom task..." required style="width: 100%; padding: 12px 14px; border-radius: 8px; border: 1px solid #ddd; outline: none; font-size: 14px; background: #fafafa;">
        <datalist id="commonTasksList">
